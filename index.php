...
<html>
  ...
  <!-- 
Place #credit, #device, #time into their own (#footer?) div that has styling applied, maybe a bar to differentiate them from #IntroText?
Stop #IntroText overlapping with this bar

Make #footer a flexbox to contain #time #device #credit. Position them vertically centered, and make the height thinner to create a sleeker look

View counter
Custom domain (.wtf if i can afford it, perhaps .dev? or .catgirl...)
-->

  <head>
    <title>DapperPixelguy</title>
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Anonymous+Pro">
    <link rel="icon" type="image/png" href="https://th.bing.com/th/id/OIP.vjJNW2lb4IlHMuTgLo_MnwHaGB?pid=ImgDet&rs=1">
    <style>
      html {
        min-height: 100%;
        overflow: hidden;
  ...
  <body>
    ...
    <body onload="startTime()">
      ...
      <div id='footer'>
        <p id='Credit'>[DapperPixelguy MMXXIII]</p>
